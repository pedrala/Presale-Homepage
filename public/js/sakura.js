...
var Sakura = function Sakura(selector, options) {
  ...
  this.createPetal = function () {
    ...
    // for the 1st release, the one color flower is defiend. 
    // Afterwards, the thress colors of the flow will be flied away. 
    if (rand === 0) {
      petal = document.createElement('div');
    } else if (rand === 1) {
      petal = document.createElement("img");
      petal.src = "images/sakura2.svg";
    } else if (rand === 2) {
      petal = document.createElement("img");
      petal.src = "images/sakura3.svg";
    } else if (rand === 3) {
      petal = document.createElement("img");
      petal.src = "images/sakura4.svg";
    } else if (rand === 4) {
      petal = document.createElement("img");
      petal.src = "images/sakura5.svg";
    }
...
Sakura.prototype.stop = function () {
  ...
  if (animId) {
    ...
    this.el.setAttribute('data-sakuza-anim-id', '');
